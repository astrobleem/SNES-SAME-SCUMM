#!/usr/bin/env python3
"""Build periodic-loop candidates from an explicitly supplied sample bank."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="derive loop candidates from an explicitly supplied sample bank",
    )
    parser.add_argument("--input-dir", type=Path, required=True,
                        help="external source-sample directory")
    parser.add_argument("--output-dir", type=Path, required=True,
                        help="generated output directory; keep outside tracked source")
    ...
    manifest = output_dir / "loop_safe_manifest.json"
