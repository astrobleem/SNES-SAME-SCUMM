...
def snapshot(session: object, frame: int) -> dict[str, object]:
    ...
    return {
        ...
        "movement_trace": {
            ...
            "product_lo": u16(session.read_memory("snesMemory", 0x7E5480, 2)),
            "product_hi": u16(session.read_memory("snesMemory", 0x7E5482, 2)),
            "actor1_post_x": u16(session.read_memory("snesMemory", 0x7E5484, 2)),
            "actor1_post_y": u16(session.read_memory("snesMemory", 0x7E5486, 2)),
            ...
            "actor1_result_hi": u16(session.read_memory("snesMemory", 0x7E548C, 2)),
            "actor1_calculated_x": u16(session.read_memory("snesMemory", 0x7E548E, 2)),
            ...
            "update_entry_count": session.read_memory("snesMemory", 0x7E5492, 1)[0],
            ...
            "position_write_count": session.read_memory("snesMemory", 0x7E54A0, 1)[0],
            "last_position_write_tick": u16(session.read_memory("snesMemory", 0x7E54A2, 2)),
            "last_position_write_tag": session.read_memory("snesMemory", 0x7E54A4, 1)[0],
