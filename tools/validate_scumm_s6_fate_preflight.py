#!/usr/bin/env python3
"""Bounded preflight against an explicitly supplied Fate demo archive."""
...
def main() -> int:
    ...
    notice_matches = EXPECTED_NOTICE_TEXT in notice
    require(notice_matches, "expected distribution-notice text is absent")
    ...
    report = {
        ...
        "expected_distribution_notice_present": notice_matches,
