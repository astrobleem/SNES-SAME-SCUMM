...
class Phase6ITests(unittest.TestCase):
    ...
    def test_script83_provenance(self):
        with tempfile.TemporaryDirectory() as d:
            ...
            subprocess.run([sys.executable,str(ROOT/"tools/cook_scumm_v5_rooms.py"),"--archive",str(archive),"--profile",str(ROOT/"examples/profiles/templates/fate_of_atlantis_demo.json"),"--rooms","49","--global-scripts","83","--executable","--output-dir",d],check=True,stdout=subprocess.DEVNULL)
