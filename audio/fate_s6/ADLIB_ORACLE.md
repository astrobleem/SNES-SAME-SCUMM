...
> Historical technical record only. The associated converted samples and MML
> are no longer distributed. This document is not permission to redistribute
> the source audio; see `docs/PR1_ASSET_PROVENANCE.md`.
...
the historical manifest removed with the converted sample outputs.
