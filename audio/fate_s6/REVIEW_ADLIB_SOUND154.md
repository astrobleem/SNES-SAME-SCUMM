...
> Historical analysis only. Referenced WAV candidates and converted MML were
> removed during asset clearance; no redistribution permission is implied.
> See `docs/PR1_ASSET_PROVENANCE.md`.
